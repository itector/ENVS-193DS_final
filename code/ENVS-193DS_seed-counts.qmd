...
::: {style="font-size: 90%; color: #787878;"}
**Figure 13. Relationship between Seed Count and Total Number of Influorescences** Scatter plot depicting the relationship between seed count and the total number of inflorescence. The x-axis represents the total number of inflorescence, and the y-axis represents seed count.
:::
