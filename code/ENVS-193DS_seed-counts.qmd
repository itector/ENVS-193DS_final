...
seedmod3 %>% 
  mutate(term = case_when(
    term == "treatmentshrub" ~ "Shrub Plot",
    term == "speciesCARRUP" ~ "Carex rupestris Species",
    term == "speciesGEUROS" ~ "Geum rossii Species",
    term == "speciesKOBMYO" ~ "Kobresia myosuroides Species",
    term == "speciesMINOBT" ~ "Minuartia obtusiloba Species",
    term == "speciesTRIDAS" ~ "Trifolium dasyphyllum Species",
    term == "total_nr_infl" ~ "Inflorescence Made by Plant",
    TRUE ~ term)) %>% 
  as_flextable() 
```
